...
<head>
    ...
    <title>Octant | Admin | @yield('title')</title>
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header">
                    ...
                    {{-- <a class="navbar-brand logo-small" href="{{Route('dashboard')}}">
                        <img src="{{asset('AdminStyle/assets/images/octant-small-logo.png')}}" alt="logo" height="30">
                    </a> --}}
                    {{-- <a class="navbar-brand logo-small" href="{{Route('dashboard')}}">
                        <img src="{{asset('AdminStyle/assets/images/octant-small-logo.png')}}" alt="logo" height="30">
                    </a> --}}
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            ...
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <a href="{{Route('account.setting.view')}}" class="dropdown-item"><i
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{Route('loan.show')}}"><i
                                    class="ti-plus"></i><span class="hide-menu">Add Loan</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{Route('borrower.show')}}"><i
                                    class="ti-menu-alt"></i><span class="hide-menu">Borrower</span></a>
                        </li>
                        @if (session('role') != "employee")
                            <li> <a class="waves-effect waves-dark" href="{{Route('loan-type.show')}}"><i
                                    class="ti-layout"></i><span class="hide-menu">Loan Type</span></a>
                            </li>
                            <li> <a class="waves-effect waves-dark" href="{{Route('credit-union.show')}}"><i
                                        class="ti-check-box"></i><span class="hide-menu">Credit Union</span></a>
                            </li>
                        @endif

                        {{-- <li> <a class="waves-effect waves-dark" href="{{Route('loan.show')}}"><i
                                    class="ti-money"></i><span class="hide-menu">Loan</span></a>
                        </li> --}}
                        <li> <a class="waves-effect waves-dark" href="{{Route('user.show')}}"><i
                                    class="ti-user"></i><span class="hide-menu">User</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{Route('loan.archived')}}"><i
                                    class="ti-archive"></i><span class="hide-menu">Archives</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{Route('account.setting.view')}}"><i
