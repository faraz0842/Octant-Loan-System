...
@section('title','Loan | Edit | Dashboard')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{Route('loan.update.dashboard',$item->loan_id)}}" method="post">
                    @method('PUT')
                    @csrf
                    @if(session('error'))
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="amount_applied"
                                        ...
                                        value="{{old('amount_applied',$item->amount_applied)}}"/>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="credit_memo"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="uw_base_fee" id="loan_type_base_fee" placeholder="UW Base Fee"
